...
import { Label as L, Input as I, Select as S, Button as B, RadioGroup } from '../common/FormElements';
...
const Popup6A_HoroscopeDetails = ({ formData, handleChange, onNext, onPrevious, 
  handleIntermediateProfileUpdate,setIsProcessing }) => {
  const {
    gotraOptions,
    rashiOptions,
    nakshatraOptions,
  ...
  const requiredFields = [
    ...
    { name: "charanaPada", label: "Charana Pada" },
    { name: "subCaste", label: "Sub Caste" },
    { name: "guruMatha", label: "Guru Matha" }
  ];
