...
const AdminDashboard = () => {
  ...
  // Existing: profile approval queue
  ...
  // ✅ NEW: Admin settings (Registration & Limits)
  ...
  const saveSettings = async () => {
    ...
    try {
      ...
      // Refresh settings + stats to reflect any changes
      await fetchSettings();
      await fetchData();
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-100">
      <div className="container mx-auto px-4 py-6">
        ...
        {loading ? (
          ...
          <>
            {/* ✅ NEW: Registration & Limits Settings */}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="rounded-lg border border-gray-100 bg-gray-50 p-4">
                  ...
                  <div className="text-xs text-gray-500 mt-2">
                    Used for mandatory registration payment (offline).
                  </div>
                </div>

                <div className="rounded-lg border border-gray-100 bg-gray-50 p-4">
                  <div className="text-sm font-semibold text-gray-800 mb-2">
                    Contact Views per Cycle (X)
                  </div>
                  <input
                    type="number"
                    min="1"
                  ...
                  />
                  <div className="text-xs text-gray-500 mt-2">
                    After X contact views, user must recharge.
                  </div>
                </div>
                ...
                <div className="rounded-lg border border-gray-100 bg-gray-50 p-4">
                  ...
                  />
                  <div className="text-xs text-gray-500 mt-2">
                    Used for offline recharge payments (ProfileRenewal).
                  </div>
                </div>
              </div>
            </div>

            {/* Pending Offline Payments Queue */}
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5 mb-6">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 mb-4">
                <div>
                  <h2 className="text-lg font-semibold text-gray-900">
                    Pending Offline Payments
                    <span className="ml-2 text-sm text-gray-500">({pendingPayments.length})</span>
                  </h2>
                  <p className="text-sm text-gray-600">
                          ...
                          <div className="flex items-center gap-2">
                            <button
                              ...
                              className={`px-3 py-2 rounded-lg text-white text-sm shadow-sm ${
                                paymentActionLoadingId === p.payment_id
                    ...
                    {filteredPendingPayments.length === 0 && (
                      <tr>
                        <td className="p-4 text-gray-500" colSpan={8}>
                          No pending offline payments found.
                        </td>
                      </tr>
                    )}
                  </tbody>
