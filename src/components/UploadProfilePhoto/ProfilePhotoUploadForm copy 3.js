...
const ProfilePhotoUploadForm = () => {
    const [searchCriteria, setSearchCriteria] = useState({
        profileId: '',
        email: 'sudha@1234.com', // Auto-populated email
        phone: '',
    });
    ...
    const handleSearchProfileLocal = async () => {
        await handleSearchProfile(
            ...
            setDefaultPhoto,
            setUploadError,
            (profileId, uploadedPhotosSetter, fetchErrorSetter) => getUploadedPhotos(profileId, uploadedPhotosSetter, fetchErrorSetter, setGettingPhotos), // Passing setGettingPhotos here
            fetchDefaultPhoto
        );
    ...
    const handleUploadPhotosLocal = async () => {
        ...
        await handleUploadPhotos(
            ...
            setDefaultPhoto,
            setGettingPhotos,
            setFetchError // Pass setFetchError here
        );
    ...
    return (
        <Paper elevation={3} sx={{ padding: 3, margin: 2 }}>
            ...
            <Grid container spacing={2} alignItems="center">
                <Grid xs={12} sm={6} md={4}> {/* Changed from <Grid item xs={...}> */}
                    <TextField
                        fullWidth
                        label="Profile ID"
                        name="profileId"
                ...
                <Grid xs={12}> {/* Changed from <Grid item xs={...}> */}
                    <Button
                        fullWidth
                        variant="contained"
                        color="primary"
