...
const AdvancedSearchResults = ({ results }) => {
  ...
  const handlePaperClick = () => {
    if (results && results.length > 0) {
      // IMPORTANT: Replace this alert with a custom message box UI as per instructions.
      // For now, keeping it as-is for direct replication.
  ...
  return (
    ...
    <div
      className="p-6 bg-gray-50 rounded-lg shadow-inner mt-4"
