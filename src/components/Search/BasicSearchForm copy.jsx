...
const BasicSearchForm = () => {
    ...
    const handleChange = (e) => {
        ...
        console.log(`handleChange called: ${name}: ${value}`); // <<-- Added for debugging Residing Country
    };
            ...
            <section className="py-8">
                <div className="container mx-auto px-6">
                    <div className="bg-white rounded-lg shadow-md p-8">
                        <Typography variant="h5" align="center" gutterBottom sx={{ fontSize: '1.5rem', fontWeight: '600', color: '#1f2937', marginBottom: '1.5rem' }}>
                        ...
                        <Box sx={{ mt: 4 }}>
                            {searchResults.length > 0 ? (
                                ...
                                !loading && <Typography align="center" className="text-gray-700 mt-4">No results found</Typography>
                            )}
                        </Box>
                    </div>
                </div>
