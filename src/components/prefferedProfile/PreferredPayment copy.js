...
function PreferredPayment() {
  ...
  const handleSubmitPayment = async (e) => {
    ...
    if (!paymentInfo.memberName || !paymentInfo.contactInfo || !paymentInfo.paymentReference) {
    ...
    try {
      ...
      const response = await fetch('https://sakhasvc-agfcdyb7bjarbtdw.centralus-01.azurewebsites.net/api//offline-payment/submit', {
        ...
        body: JSON.stringify({
          ...
          phone_number: paymentInfo.phoneNumber || paymentInfo.contactInfo,
      ...
      console.log("[PreferredPayment] API response:", result);
        ...
        <Container maxWidth="md">
          <Paper elevation={3} sx={{ p: 4, borderRadius: 2 }}>
            <Typography variant="h4" sx={{ color: "#4caf50", fontWeight: "bold", mb: 2 }}>
              Thank you for Your Preferred Profile Payment!
            </Typography>
            <Typography sx={{ color: "#555", mb: 3 }}>
              Your preferred profile payment information has been submitted and recorded in our database. Our team will process your payment shortly and your profile will be marked as preferred.
            </Typography>
            ...
            <Box sx={{ bgcolor: "#f9f9f9", p: 3, borderRadius: 2, mt: 2 }}>
              ...
              <Grid container spacing={2}>
                ...
                <Grid item xs={8} sm={9}>
                  <Typography>{paymentInfo.profileId}</Typography>
                </Grid>
                ...
                <Grid item xs={8} sm={9}>
                  <Typography>{paymentInfo.memberName}</Typography>
                </Grid>
                ...
                <Grid item xs={8} sm={9}>
                  <Typography>{paymentInfo.email}</Typography>
                </Grid>
                ...
                <Grid item xs={8} sm={9}>
                  <Typography>{paymentInfo.paymentMethod === 'UPI' ? 'UPI' : 
                ...
                <Grid item xs={8} sm={9}>
                  <Typography>{paymentInfo.paymentReference}</Typography>
                </Grid>
        ...
        <Paper elevation={3} sx={{ p: 4, borderRadius: 2 }}>
          ...
          <Box component="form" onSubmit={handleSubmitPayment} sx={{ mt: 4 }}>
            ...
            <Typography variant="body2" sx={{ color: "#555", mb: 3 }}>
              Please provide your payment details below. Preferred profile fee is ₹250. Our team will process your payment and mark your profile as preferred.
            </Typography>
