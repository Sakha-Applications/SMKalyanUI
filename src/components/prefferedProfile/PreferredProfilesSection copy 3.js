...
import { Star, MapPin, Briefcase, Calendar, Heart, User, Clock, ChevronLeft, ChevronRight, Pause, Play } from 'lucide-react';
              ...
              <div className="relative bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 p-6">
                ...
                <div className="text-center">
                  ...
                  <p className="text-white/80 text-sm">
                    Profile ID: {currentProfile.profile_id}
                  </p>
                </div>
              </div>
              ...
              <div className="p-6 space-y-5">
                ...
                <div className="pt-4 border-t border-gray-100">
                  <div className="flex space-x-3">
                    <button className="flex-1 bg-pink-500 text-white py-3 px-4 rounded-lg hover:bg-pink-600 transition-colors font-medium">
                      View Profile
                    </button>
